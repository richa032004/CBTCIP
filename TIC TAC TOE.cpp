...
void outputBoard(int board[9]) {
	cout << "     |     |     \n";
	cout << "  " << numberToLetter(board[0]) << "  |  " << numberToLetter(board[1]) << "  |  " << numberToLetter(board[2]) << "  \n";
	cout << "_____|_____|_____\n";
	cout << "     |     |     \n";
	cout << "  " << numberToLetter(board[3]) << "  |  " << numberToLetter(board[4]) << "  |  " << numberToLetter(board[5]) << "  \n";
	cout << "_____|_____|_____\n";
	cout << "     |     |     \n";
	cout << "  " << numberToLetter(board[6]) << "  |  " << numberToLetter(board[7]) << "  |  " << numberToLetter(board[8]) << "  \n";
	cout << "     |     |     \n";
}
